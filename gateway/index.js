...
app.get('/', (req, res) => {
  res.status(200).json({
    message: 'Welcome to Coffy API v1',
    services: [
      { path: '/api/v1/admin', description: 'Admin Service (API v1)' },
      { path: '/api/v1/admin-auth', description: 'Admin Auth Service (API v1)' },
      { path: '/api/v1/user/auth', description: 'User Auth Service (API v1)' },
